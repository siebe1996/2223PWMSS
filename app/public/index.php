...
$router->get('/account', 'UserController@showAccountInfo');
$router->get('/account/months/(\d+)', 'UserController@showSearchResults');
$router->post('/account/search', 'UserController@search');
...
$router->get('/badrequest', 'ErrorController@badRequest');
